...
const VARIANT_GROUPS = {
  ...
  oak: ["minecraft:oak_planks", "minecraft:oak_slab", "minecraft:oak_stairs", "minecraft:oak_fence", "minecraft:oak_fence_gate", "create:oak_window", "create:oak_window_pane"],
  spruce: ["minecraft:spruce_planks", "minecraft:spruce_slab", "minecraft:spruce_stairs", "minecraft:spruce_fence", "minecraft:spruce_fence_gate", "create:spruce_window", "create:spruce_window_pane"],
  birch: ["minecraft:birch_planks", "minecraft:birch_slab", "minecraft:birch_stairs", "minecraft:birch_fence", "minecraft:birch_fence_gate", "create:birch_window", "create:birch_window_pane"],
  jungle: ["minecraft:jungle_planks", "minecraft:jungle_slab", "minecraft:jungle_stairs", "minecraft:jungle_fence", "minecraft:jungle_fence_gate", "create:jungle_window", "create:jungle_window_pane"],
  acacia: ["minecraft:acacia_planks", "minecraft:acacia_slab", "minecraft:acacia_stairs", "minecraft:acacia_fence", "minecraft:acacia_fence_gate", "create:acacia_window", "create:acacia_window_pane"],
  dark_oak: ["minecraft:dark_oak_planks", "minecraft:dark_oak_slab", "minecraft:dark_oak_stairs", "minecraft:dark_oak_fence", "minecraft:dark_oak_fence_gate", "create:dark_oak_window", "create:dark_oak_window_pane"],
  mangrove: ["minecraft:mangrove_planks", "minecraft:mangrove_slab", "minecraft:mangrove_stairs", "minecraft:mangrove_fence", "minecraft:mangrove_fence_gate", "create:mangrove_window", "create:mangrove_window_pane"],
  ...
  crimson: ["minecraft:crimson_planks", "minecraft:crimson_slab", "minecraft:crimson_stairs", "minecraft:crimson_fence", "minecraft:crimson_fence_gate", "create:crimson_window", "create:crimson_window_pane"],
  warped: ["minecraft:warped_planks", "minecraft:warped_slab", "minecraft:warped_stairs", "minecraft:warped_fence", "minecraft:warped_fence_gate", "create:warped_window", "create:warped_window_pane"],
  ...
  glass: [
    ...
    "quark:dirty_glass", "quark:dirty_glass_pane",
  ],
  ...
  quark_iron_plate: [
    ...
    "ptdye:gray_fence", "ptdye:gray_fence_gate", "create:ornate_iron_window", "create:ornate_iron_window_pane",
  ],
  ...
  // Log variants with quark posts
  oak_log: ["minecraft:oak_log", "quark:oak_post"],
  stripped_oak_log: ["minecraft:stripped_oak_log", "quark:stripped_oak_post"],
  spruce_log: ["minecraft:spruce_log", "quark:spruce_post"],
  stripped_spruce_log: ["minecraft:stripped_spruce_log", "quark:stripped_spruce_post"],
  birch_log: ["minecraft:birch_log", "quark:birch_post"],
  stripped_birch_log: ["minecraft:stripped_birch_log", "quark:stripped_birch_post"],
  jungle_log: ["minecraft:jungle_log", "quark:jungle_post"],
  stripped_jungle_log: ["minecraft:stripped_jungle_log", "quark:stripped_jungle_post"],
  acacia_log: ["minecraft:acacia_log", "quark:acacia_post"],
  stripped_acacia_log: ["minecraft:stripped_acacia_log", "quark:stripped_acacia_post"],
  dark_oak_log: ["minecraft:dark_oak_log", "quark:dark_oak_post"],
  stripped_dark_oak_log: ["minecraft:stripped_dark_oak_log", "quark:stripped_dark_oak_post"],
  mangrove_log: ["minecraft:mangrove_log", "quark:mangrove_post"],
  stripped_mangrove_log: ["minecraft:stripped_mangrove_log", "quark:stripped_mangrove_post"],
  cherry_log: ["minecraft:cherry_log", "quark:cherry_post"],
  stripped_cherry_log: ["minecraft:stripped_cherry_log", "quark:stripped_cherry_post"],
  blossom_log: ["quark:blossom_log", "quark:blossom_post"],
  stripped_blossom_log: ["quark:stripped_blossom_log", "quark:stripped_blossom_post"],
  bamboo_block: ["minecraft:bamboo_block", "quark:bamboo_post"],
  stripped_bamboo_block: ["minecraft:stripped_bamboo_block", "quark:stripped_bamboo_post"],
  crimson_stem: ["minecraft:crimson_stem", "quark:crimson_post"],
  stripped_crimson_stem: ["minecraft:stripped_crimson_stem", "quark:stripped_crimson_post"],
  warped_stem: ["minecraft:warped_stem", "quark:warped_post"],
  stripped_warped_stem: ["minecraft:stripped_warped_stem", "quark:stripped_warped_post"],
};
